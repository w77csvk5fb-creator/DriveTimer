...
export function LocationErrorBanner({ error }: LocationErrorBannerProps) {
  return (
    <div className="flex flex-col gap-1 rounded-xl border border-accent-urgent/40 bg-surface-raised-1/90 px-3 py-2 text-center text-sm text-accent-urgent shadow-lg">
